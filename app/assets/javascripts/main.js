...
CHAKRA.map = function(){
	if($('.map').length > 0)
	{
		...
		$('.map').each(function(i,e){
			...
			var contentString = '<p><strong>Crypsis Technologies Pvt. Ltd.</strong><br> Plot No. 257/A,<br>Prashasan Nagar, Road No. 72,<br>Near Nyaya Vihar (Bungalows for High Court Judges),<br>Road No. 78 (Narne Road),<br>Jubilee Hills, Hyderabad - 500 033<br><br>Link to Google Maps :<br><a href="http://goo.gl/maps/FTZ9f" target="blank">http://goo.gl/maps/FTZ9f</a></p>';
